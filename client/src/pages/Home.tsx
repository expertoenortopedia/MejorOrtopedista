        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Lesión de meniscos", desc: "Atención especializada si sientes bloqueos en la rodilla, dolor agudo al rotar o inestabilidad.", icon: Bone, img: "https://res.cloudinary.com/dcuuvanw3/image/upload/v1772504807/ChatGPT_Image_2_mar_2026_08_22_19_p.m._l2zhyv.png", link: "/lesion-menisco-cuautitlan-izcalli" },
              { title: "Ligamento cruzado", desc: "Reconstrucción y tratamiento tras lesiones deportivas o accidentes que causan fallo en la rodilla.", icon: HeartPulse, img: "https://res.cloudinary.com/dcuuvanw3/image/upload/v1772504807/ChatGPT_Image_2_mar_2026_08_25_25_p.m._ypmatf.png", link: "/ligamento-cruzado-anterior-cuautitlan-izcalli" },
              { title: "Desgaste articular (Artrosis)", desc: "Tratamientos para el desgaste del cartílago. Retrasamos el avance y aliviamos el dolor profundo.", icon: Stethoscope, img: "https://res.cloudinary.com/dcuuvanw3/image/upload/v1772504807/ChatGPT_Image_2_mar_2026_08_25_21_p.m._nsoamr.png", link: "/artrosis-rodilla-cadera-cuautitlan-izcalli" },
              { title: "Dolor de hombro", desc: "Alivio para dolor al levantar el brazo, manguito rotador, tendinitis y hombro congelado.", icon: UserCheck, img: "https://res.cloudinary.com/dcuuvanw3/image/upload/v1772504806/ChatGPT_Image_2_mar_2026_08_25_28_p.m._uec0au.png", link: "/dolor-hombro-manguito-rotador-cuautitlan-izcalli" },
              { title: "Lesiones deportivas", desc: "Recuperación rápida y segura para que regreses a tu deporte favorito en tu máximo rendimiento.", icon: Award, img: "https://res.cloudinary.com/dcuuvanw3/image/upload/v1772504807/ChatGPT_Image_2_mar_2026_08_25_32_p.m._gyz5p4.png", link: "/lesiones-deportivas-cuautitlan-izcalli" },
            ].map((item, idx) => {
              const cardContent = (
                <Card key={idx} className={`border border-slate-100 hover:border-primary/20 shadow-sm hover:shadow-md transition-all group overflow-hidden ${item.link ? "cursor-pointer" : ""}`} data-testid={`card-specialty-${idx}`}>
                  <CardContent className="p-8">
                    <div className="mb-6 bg-slate-50 group-hover:bg-primary/5 rounded-2xl w-[5.5rem] h-[5.5rem] mx-auto flex items-center justify-center transition-colors overflow-hidden">
                      {item.img ? (
